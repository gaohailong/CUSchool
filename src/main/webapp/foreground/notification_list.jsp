                            ...
                            <ul>
                                <c:forEach begin="1" end="${totalPage}" varStatus="i">
                                    <c:if test="${i.index==nowPage}">
                                     <li class="current" ><a href="findPreNotificationTitle.action?nowPage=${i.index}">${i.index}</a></li>
                                    </c:if>
                                    <c:if test="${i.index!=nowPage}">
                                        <li class="" ><a href="findPreNotificationTitle.action?nowPage=${i.index}">${i.index}</a></li>
                                    </c:if>
                                </c:forEach>
                            </ul>
                        </div>

                ...
                <div class="main_content">
                    ...
                    <c:forEach var="title" items="${titleList}">
                        <div class="block_home_post">
                            <div class="text">
                                <p class="title"><a href="findPreOneSchoolOther.action?tid=${title.TId}">${title.TName}</a></p>
                                <div class="icons">
                                    <ul>
                            ...
                            <ul>
                                <c:forEach begin="1" end="${totalPage}" varStatus="i">
                                    <c:if test="${i.index==nowPage}">
                                         <li class="current" ><a href="findAllDataOther.action?nowPage=${i.index}">${i.index}</a></li>
                                    </c:if>
                                    <c:if test="${i.index!=nowPage}">
                                        <li class="" ><a href="findAllDataOther.action?nowPage=${i.index}">${i.index}</a></li>
                                    </c:if>
                                </c:forEach>
                            </ul>
                        </div>

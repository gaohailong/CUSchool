                        ...
                        <div class="pages">
                            <ul>
                                <c:forEach begin="1" end="${totalPage}" varStatus="i">
                                    ...
                                    <li class="current" ><a href="findSearchHome.action?nowPage=${i.index}&keyword=${keyword}">${i.index}</a></li>
                                    </c:if>
                                    <c:if test="${i.index!=nowPage}">
                                        <li class="" ><a href="findSearchHome.action?nowPage=${i.index}&keyword=${keyword}">${i.index}</a></li>
                                    </c:if>
                                </c:forEach>
                            </ul>
                        </div>

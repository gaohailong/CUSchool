    ...
    <div id="sidebar" class="sidebar">
        <div class="sidebar-menu nav-collapse">
            ...
            <ul>
                ...
                <li class="current active"><a class="" href="findSchoolRecruitment.action"><i class="fa fa-file-text fa-fw"></i> <span
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12" id="add">
                    ...
                    <button class="btn btn-block btn-primary" onclick="javascript:updateExchangeWork(${title.TId})">提交</button>
                </div>
            </div>
        </div>
    </div>

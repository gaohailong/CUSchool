            ...
            <ul>
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub">
                        ...
                        <li class="current"><a class="" href="findServiceSociety.action"><span class="sub-menu-text">社会服务</span></a></li>
                    </ul>
                </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12" id="add">
                    ...
                    <button class="btn btn-block btn-primary" onclick="javascript:updateSocietyService(${title.TId})">提交</button>
                </div>
            </div>
        </div>
    </div>

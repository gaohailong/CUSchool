	...
	<section id="page">
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="findSchoolVideo.action"><span class="sub-menu-text">视频展示</span></a></li>
		...
		<div id="main-content">
			<div class="container">
                ...
                <div class="row">
                  	  <div class="col-md-12"><a href="getTokenVideo.action" class="col-md-offset-10"><button class="btn btn-primary">添加视频</button></a></div>
                                    ...
                                    <div class="box-title">
                                        ...
                                        <div class="tools">
                                            <%--<c:if test="${empty video}">--%>
                                                <%--<a href="<%=request.getContextPath()%>/background/school_video_add.jsp"><button class="btn btn-success tip-right" >添加</button></a>--%>
                                            <%--</c:if>--%>
                                            <c:if test="${not empty video}">
                                                <a href="javascript:confirmDeleteVideo(${video.VId})"><button class="btn btn-danger tip-right" >删除</button></a>
                                                <a href="findOneSchoolVideo.action?vid=${video.VId}"><button class="btn btn-success tip-right" >修改</button></a>
                                            </c:if>
                                        </div>
                                    </div>
                                        <div class="box-body big">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <%--<input type="email" class="form-control" id="video_link" placeholder="">--%>
                                                    <%-- todo 设置视频链接 --%>
                                                    <p class="">${video.VLink}</p>
                                                </div>
                                            </div>
                                            <div class="form-group">

		...
		<div class="container">
			...
			<ul class="nav navbar-nav pull-right">
				...
				<%--<li class="dropdown user" id="header-user">--%>
					<%--<a href="#" class="dropdown-toggle" data-toggle="dropdown">--%>
						<%----%>
						<%--&lt;%&ndash;<img alt="" src="img/avatars/avatar3.jpg"/>&ndash;%&gt;--%>
						<%--&lt;%&ndash;<span class="username">欢迎：${loginUser}</span>&ndash;%&gt;--%>
						<%--&lt;%&ndash;<i class="fa fa-angle-down"></i>&ndash;%&gt;--%>
					<%--</a>--%>
					<%--&lt;%&ndash;<ul class="dropdown-menu">&ndash;%&gt;--%>
						<%--&lt;%&ndash;<li><a href="login.html"><i class="fa fa-power-off"></i> Log Out</a></li>&ndash;%&gt;--%>
					<%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
				<%--</li>--%>
	...
	<section id="page">
		...
		<div id="main-content">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12"><a href="adminAddAdministration.action" class="col-md-offset-10"><button class="btn btn-primary">添加文章</button></a></div>
					<div class="col-md-12" style="margin-top: 20px;">
						<!-- BOX -->
						<div class="box border inverse">
							<div class="box-title">
								<h4><i class="fa fa-table"></i>行政机构</h4>
							</div>
							<div class="box-body">

						...
						<ul class="col-md-7 pagination pagination-lg  ">
							<c:forEach begin="1" end="${totalPage}" varStatus="i">
								<c:if test="${i.index==nowPage}">
									<li class="active"><a href="findSchoolIntroduce.action?nowPage=${i.index}" onclick="javascript">${i.index}</a></li>
								</c:if>
								<c:if test="${i.index!=nowPage}">
									<li class=""><a href="findSchoolIntroduce.action?nowPage=${i.index}" onclick="javascript">${i.index}</a></li>
								</c:if>
							</c:forEach>

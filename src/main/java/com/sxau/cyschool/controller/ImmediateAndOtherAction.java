 ...
 * 特色专业
 */
public class ImmediateAndOtherAction extends ActionSupport {
    //注入元素
    ...
    public String findImmediate() throws Exception {
        ...
        return "findImmediateOther";
    }

    //查找一个现任领导
    public String findOneImmediate() throws Exception {
        if (tid == null || tid == 0) {
            return ERROR;
        }
        title = titleService.findTitleById(tid);
        return "updateSchoolAdministration";
    }
    ...
    public String addImmediate() throws Exception {
        ...
        title.setTRead(0);
        Category category = categoryService.getCategoryByName("直属及其他");

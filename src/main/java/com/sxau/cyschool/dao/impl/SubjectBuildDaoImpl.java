 ...
 */
public class SubjectBuildDaoImpl extends BaseHibernateDaoImpl<Title> implements TitleDao {
    ...
    public List<Title> queryTitleByPageAndCondition(Title title, int page, int rows) throws Exception {
        ...
        string.append("and t.category.CContent='学科建设'");
    ...
    public int queryTitleCondition(Title title) throws Exception {
        ...
        stringBuffer.append("and t.category.CContent='学科建设'");

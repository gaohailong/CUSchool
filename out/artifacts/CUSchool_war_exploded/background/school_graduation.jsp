	...
	<section id="page">
		...
		<div id="main-content">
			<div class="container">
				...
				<!-- /PAGE HEADER -->
				<div class="row">
					<div class="col-md-12"><a href="<%request.getContextPath();%>/cyschool/background/school_graduation_add.jsp" class="col-md-offset-10"><button class="btn btn-primary">添加文章</button></a></div>
					<div class="col-md-12" style="margin-top: 20px">
						<!-- BOX -->
						<div class="box border inverse">
							<div class="box-title">
								<h4><i class="fa fa-table"></i>毕业风采</h4>
							</div>
							<div class="box-body">
								<table class="table table-bordered">
									...
									<c:forEach var="titles" items="${titleList}" step="1" varStatus="i">
										<tr>
											...
											<td>${titles.TRead}</td>
											<td>
												<a href="findOneSchoolGraduation.action?tid=${titles.TId}" style="text-underline: none">
													<img src="self/images/update.png" alt="update"
														 style="width: 20px;height: 20px;margin-left: 10px"/>
												</a>
												<a href="javascript:confirmDeleteGraduation(${titles.TId});">
						...
						<ul class="pagination ">
							<c:forEach begin="1" end="${totalPage}" varStatus="i">
								<c:if test="${i.index==nowPage}">
									<li class="active"><a href="findSchoolGraduation.action?nowPage=${i.index}" onclick="javascript">${i.index}</a></li>
								</c:if>
								<c:if test="${i.index!=nowPage}">
									<li class=""><a href="findSchoolGraduation.action?nowPage=${i.index}" onclick="javascript">${i.index}</a></li>
								</c:if>
							</c:forEach>
						</ul>
							</div>

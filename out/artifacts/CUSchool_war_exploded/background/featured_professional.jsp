	...
	<section id="page">
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="featuredSchoolProfessional.action"><span class="sub-menu-text">特色专业</span></a></li>
		...
		<div id="main-content">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12"><a href="<%request.getContextPath();%>/cyschool/background/featured_professional_add.jsp" class="col-md-offset-10"><button class="btn btn-primary">添加文章</button></a></div>

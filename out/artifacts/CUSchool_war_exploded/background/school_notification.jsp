        ...
        <div class="sidebar-menu nav-collapse">
            ...
            <ul>
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub">
                        <li class="current"><a class="" href="findNotificationTitle.action"><span class="sub-menu-text">通知公告</span></a></li>
    ...
    <div id="main-content">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12"><a href="<%request.getContextPath();%>/cyschool/background/school_notification_add.jsp" class="col-md-offset-10"><button class="btn btn-primary">添加文章</button></a></div>
                <div class="col-md-12" id="find" style="margin-top: 20px">
                    <!-- BOX -->
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach var="titles" items="${titleList}" step="1" varStatus="i">
                                    <tr>
                                        ...
                                        <td>${titles.TRead}</td>
                                        <td>
                                            <a href="findOneNotificationTitle.action?tid=${titles.TId}" style="text-underline: none">
                                                <img src="self/images/update.png" alt="update"
                                                     style="width: 20px;height: 20px;margin-left: 10px"/>
                                            </a>
                                            <a href="javascript:confirmDelete(${titles.TId});">
                    ...
                    <ul class="pagination">
                        <c:forEach begin="1" end="${totalPage}" varStatus="i">
                            <c:if test="${i.index==nowPage}">
                                <li class="active"><a href="findNotificationTitle.action?nowPage=${i.index}">${i.index}</a></li>
                            </c:if>
                            <c:if test="${i.index!=nowPage}">
                                <li><a href="findNotificationTitle.action?nowPage=${i.index}">${i.index}</a></li>
                            </c:if>
                        </c:forEach>
                    </ul>
                        </div>

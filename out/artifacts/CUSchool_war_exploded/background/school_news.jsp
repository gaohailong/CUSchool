	...
	<section id="page">
						...
						<ul>
							...
							<li class="has-sub active">
								...
								<ul class="sub">
									...
									<li class="current"><a class="" href="findSchoolNews.action"><span class="sub-menu-text">学校要闻</span></a></li>
		...
		<div id="main-content">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12"><a href="<%request.getContextPath();%>/cyschool/background/school_news_add.jsp" class="col-md-offset-10"><button class="btn btn-primary">添加文章</button></a></div>
					<div class="col-md-12" style="margin-top: 20px;">
						<!-- BOX -->
						<div class="box border inverse">
							<div class="box-title">
								<h4><i class="fa fa-table"></i>学校要闻</h4>
							</div>
							<div class="box-body">

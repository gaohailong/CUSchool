...
<section id="page">
        ...
        <div class="sidebar-menu nav-collapse">
            ...
            <ul>
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub">
                        <li class="current"><a class="" href="findSchoolPrincipal.action"><span class="sub-menu-text">校长致辞</span></a></li>
    ...
    <div id="main-content">
        <div class="container">
            ...
            <div class="row">
                <%--<div class="col-md-12"><a href="<%request.getContextPath();%>/background/school_principal_add.jsp" class="col-md-offset-10"><button class="btn btn-primary">添加文章</button></a></div>--%>
                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach var="titles" items="${titleList}" step="1" varStatus="i">
                                    <tr>
                                        ...
                                        <td>${titles.TRead}</td>
                                        <td>
                                            <a href="findOneSchoolPrincipal.action?tid=${titles.TId}" style="text-underline: none">
                                                <img src="self/images/update.png" alt="update"
                                                     style="width: 20px;height: 20px;margin-left: 10px"/>
                                            </a>
                                            <a href="javascript:confirmDeletePrincipal(${titles.TId});">
...
<script>
    jQuery(document).ready(function () {
        App.setPage("school_principal");  //Set current page

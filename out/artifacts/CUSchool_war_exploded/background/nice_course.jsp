	...
	<section id="page">
		...
		<div id="main-content">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12"><a href="<%request.getContextPath();%>/cyschool/background/nice_course_add.jsp" class="col-md-offset-10"><button class="btn btn-primary">添加文章</button></a></div>
								...
								<table class="table table-bordered">
									...
									<c:forEach var="titles" items="${titleList}" step="1" varStatus="i">
										<tr>
											...
											<td>${titles.TRead}</td>
											<td>
												<a href="findOneNiceCourse.action?tid=${titles.TId}" style="text-underline: none">
													<img src="self/images/update.png" alt="update"
														 style="width: 20px;height: 20px;margin-left: 10px"/>
												</a>
												<a href="javascript:confirmDeleteNiceCourse(${titles.TId});">

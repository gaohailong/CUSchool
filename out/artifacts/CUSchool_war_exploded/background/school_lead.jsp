	...
	<section id="page">
		...
		<div id="main-content">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12"><a href="<%request.getContextPath();%>/cyschool/background/school_lead_add.jsp" class="col-md-offset-10"><button class="btn btn-primary">添加文章</button></a></div>
					<div class="col-md-12" style="margin-top: 20px;">
						<!-- BOX -->
						<div class="box border inverse">
							<div class="box-title">
								<h4><i class="fa fa-table"></i>现任领导</h4>
							</div>
							<div class="box-body">
									...
									<c:forEach var="titles" items="${titleList}" step="1" varStatus="i">
										<tr>
											...
											<td>
												...
												<a href="javascript:confirmDeleteLeader(${titles.TId});">

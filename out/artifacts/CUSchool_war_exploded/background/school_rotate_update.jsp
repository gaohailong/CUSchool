            ...
            <ul>
                ...
                <li class="has-sub active">
                    ...
                    <ul class="sub">
                        ...
                        <li class="current"><a class="" href="findRotatePicture.action"><span class="sub-menu-text">首页轮播图</span></a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12" id="add">
                    ...
                    <button class="btn btn-block btn-primary" onclick="javascript:updateRotatePicture(${title.TId})">提交</button>
                </div>
            </div>
        </div>
    </div>
